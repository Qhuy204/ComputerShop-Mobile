...
data class OrderItem(
    @get:PropertyName("order_item_id") @set:PropertyName("order_item_id") var order_item_id: Int = 0,
    @get:PropertyName("order_id") @set:PropertyName("order_id") var order_id: Int? = null,
